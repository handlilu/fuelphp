...
<script src="/lilu/fuelphp/public/assets//lilu/fuelphp/public/assets/js/jquery.min.js"></script>
<!-- Custom Theme files -->
<!--theme-style-->
...
<script type="text/javascript" src="/lilu/fuelphp/public/assets/js/move-top.js"></script>
<script type="text/javascript" src="/lilu/fuelphp/public/assets/js/easing.js"></script>
<!-- slide -->
</head>
<body>
<!--header-->
	...
	<div class="banner">
		 <div class="container">
			<div class="col-md-6 banner-matter">
				...
				<script src="/lilu/fuelphp/public/assets/js/owl.carousel.js"></script>
							        <script>
				...
				<div class="col-md-6 banner-side">
					<div class="col-md-6 side">
						<img class="img-responsive" src="/lilu/fuelphp/public/assets/img/ba.jpg" alt="">
					</div>
					<div class="col-md-6 side">
						<img class="img-responsive" src="/lilu/fuelphp/public/assets/img/ba1.jpg" alt="">
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="clearfix"> </div>
